...
public class TelaContator extends javax.swing.JFrame {
    ...
    private void btnContActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContActionPerformed
        ...
        DefaultListModel lista = new DefaultListModel(); //Foi criado um objeto chamado lista.
                
        for (int c=i; c<=f; c+=p){
            lista.addElement(c); //adiciona um elemento c Contador nessa lista
        }
        lstCont.setModel(lista); //lstCont recebe a lista
